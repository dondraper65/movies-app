                ...
                <div className="flex-container">
                    <div className="left">
                        <ImageList rowHeight={350} cols={4} className={classes.imageListMain}>
                            {moviesData.map(movie => (
                                <ImageListItem className="released-movie-imagelist-item" key={"grid" + movie.id} onClick = {() => this.movieClickHandler(movie.id)}>
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <FormControl className = {classes.formControl}>
                                    ...
                                    < Select multiple input= {<Input id = "select-multiple-checkbox-genre" />} renderValue = {selected => selected.join(',')} value = {this.state.genres} onChange = {this.genreSelectHandler}>
